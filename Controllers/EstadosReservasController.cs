...
namespace Proyecto_Final_Web.Controllers
{
    ...
    public class EstadosReservasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstadoReserva,Nombre")] EstadosReserva estadosReserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadoReserva,Nombre")] EstadosReserva estadosReserva)
        {
